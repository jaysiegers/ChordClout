...
const Login = () => {
  ...
  return (
    ...
    <div className="h-screen w-screen flex items-center justify-center max-w-3xl mx-auto">
       <img src={poster} alt="poster" className="mx-auto rounded-lg transform hover:-translate-y-1 transition duration-500"/>
